<?php /* Smarty version Smarty-3.0.7, created on 2018-03-23 03:16:57
         compiled from "/var/www/html/timetracker/WEB-INF/templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13141059395ab4b7f92c8105-60725114%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f25efd88097ffcb1ebb0070f9d213d5c73334438' => 
    array (
      0 => '/var/www/html/timetracker/WEB-INF/templates/header.tpl',
      1 => 1521067864,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13141059395ab4b7f92c8105-60725114',
  'function' => 
  array (
  ),
...
" target="_blank"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['help'];?>
    ...
    <?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')&&($_smarty_tpl->getVariable('user')->value->can('manage_invoices')||$_smarty_tpl->getVariable('user')->value->can('view_own_invoices'))){?>
    ...
    <?php }?>
    <?php if ((@MODE_PROJECTS_AND_TASKS==$_smarty_tpl->getVariable('user')->value->tracking_mode)&&$_smarty_tpl->getVariable('user')->value->can('manage_tasks')){?>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')&&$_smarty_tpl->getVariable('user')->value->can('manage_clients')){?>
...
</b><?php }?><?php if ($_smarty_tpl->getVariable('user')->value->team){?>, <?php echo smarty_modifier_escape($_smarty_tpl->getVariable('user')->value->team);?>
<?php }?></td></tr>
      </table>
<?php }?>
