<?php /* Smarty version Smarty-3.0.7, created on 2018-03-23 08:21:29
         compiled from "/var/www/html/timetracker/WEB-INF/templates/reports.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18841273395ab4ff59074cb6-01897341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '43d3b06b7732a762111bf84aade8b62470b470bd' => 
    array (
      0 => '/var/www/html/timetracker/WEB-INF/templates/reports.tpl',
      1 => 1521433660,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18841273395ab4ff59074cb6-01897341',
  'function' => 
  array (
  ),
...
<?php if (($_smarty_tpl->getVariable('user')->value->canManageTeam()&&$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ps'))){?>
        <tr>
          <td><b><?php echo $_smarty_tpl->getVariable('i18n')->value['label']['paid_status'];?>
</b></td>
        </tr>
        <tr>
          <td><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['paid_status']['control'];?>
</td>
        </tr>
<?php }?>
...
<?php if ($_smarty_tpl->getVariable('user')->value->canManageTeam()||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ps')){?>
              <tr>
...
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['invoice'];?>
  ...
  <?php }?>
  <?php if (($_smarty_tpl->getVariable('user')->value->canManageTeam()&&$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ps'))){?>
                <td width="25%"><label><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chpaid']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['paid'];?>
</label></td>
  <?php }?>
  <?php if ($_smarty_tpl->getVariable('user')->value->canManageTeam()){?>
                <td width="25%"><label><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chip']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['ip'];?>
</label></td>
  <?php }?>
              </tr>
<?php }?>
...
<?php if ((($_smarty_tpl->getVariable('user')->value->canManageTeam()||$_smarty_tpl->getVariable('user')->value->isClient())||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ex'))){?>
...
&nbsp;<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('custom_fields')->value->fields[0]['label']);?>
</label></td>
<?php }else{ ?>
                <td></td>
<?php }?>
